    install.packages("qqman",repos="https://cran.r-project.org/web/packages/qqman/",lib="~" ) # location of installation can be changed but has to correspond with the library location 
